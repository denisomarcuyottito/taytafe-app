  ...
  },
  {
    ...
    menu: [
      ...
      },
      {
        menuId: 9,
        name: "Toma hawk",
        photo: images.tomahawk,
        description:
          "Corte que demora 30 minutos, término medio y para dos personas a más, el corte proviene del Ribeye con hueso muy recomendado",
        calories: 1400,
        price: 111.99,
      },
    ],
    ...
    menu: [
      {
        ...
        photo: images.CesarDePollo,
        description:
          "Mix de lechugas, pollo grillado, croutones, queso parmesano, vinagreta Cesar.",
        calories: 500,
        price: 24.99,
      },
    ],
    ...
    menu: [
      {
        ...
        photo: images.HamburguesaClasica,
        description:
          "Un Blend de Bife ancho, Pecho de res, Asado de tira Nacional, en pan papa amarilla, lechuga, tomate y salsa especial",
        calories: 500,
        price: 20.99,
      },
      {
        ...
        description:
          "Un blend de bife ancho, pecho de res, asado de tira nacional, en pan papa amarilla, chorizo, tomate, chimichurri de perejil y salsa especial",
        calories: 700,
        price: 25.99,
      },
      {
        ...
        description:
          "Pierna de pollo sazonado con especies orientales frito en alta temperatura acompañado de pan de brioche",
        calories: 450,
        price: 17.99,
      },
      {
        ...
        description:
          "Un Blend de Bife ancho, Pecho de res, Asado de tira Nacional, en pan papa Amarilla, tocino Crocante, bañada con salsa de queso Cheddar, lechuga, tomate y salsa especial",
        calories: 650,
        price: 22.99,
      },
      {
        ...
        description:
          "Un Blend de bife ancho, Pecho de res, asado de tira nacional, en pan papa amarilla, tocino, bañada en salsa de queso Cheddar, lechuga, tomate y salsa especial",
        calories: 600,
        price: 31.99,
      },
      {
        ...
        description:
          "En nuestro pan de casa Brioch con Chia, tocino artesanal, nuestra salsa especial y bañada con su salsa de queso Cheddar.",
        calories: 700,
        price: 34.99,
      },
    ],
    ...
    menu: [
      {
        ...
        description:
          "Lomo fino de res (200 gr), Bife angosto (200 gr), Picaña (200 gr), Bife ancho (200 gr), ensalada y papas fritas",
        calories: 2000,
        price: 111.99,
      },
      {
        ...
        description:
          "Lomo fino de res o bife (250 gr), chuleta de cerdo, chorizo de casa, ensalada y papas fritas",
        calories: 800,
        price: 56.99,
      },
      {
        ...
        photo: images.ParrillaTaytaFe,
        description:
          "Lomo fino de res o Bife (250 gr), chuleta de cerdo (2), pechuga de pollo (2), anticuchos (2), chorizo de casa (2), ensaladas y papas fritas.",
        calories: 1800,
        price: 101.99,
      },
      {
  ...
  },
  {
    ...
    menu: [
      ...
      },
      {
        ...
        description:
          "Alitas crocantes bañadas con salsa Búfalo de casa y acompañada con papas fritas",
        calories: 350,
        price: 16.99,
      },
      {
        ...
        description:
          "Alitas crocantes bañadas con salsa de sauco con toque picante   y acompañada con papas fritas",
        calories: 320,
        price: 16.99,
      },
      {
        ...
        description:
          "Panceta de cerdo, cocida en su propia grasa por 6 horas y luego llevada a la parrilla, bañada con salsa BBQ de casa y acompañadas con papas fritas",
        calories: 480,
        price: 27.99,
      },
    ],
    ...
    menu: [
      {
        ...
        photo: images.EsferaDeChocolate,
        description:
          "Rellena con fresa, helado de lúcuma (temporada), espuma de quinua, bañado con tofee",
        calories: 600,
        price: 21.99,
      },
      {
    ...
    menu: [
      {
        ...
        description:
          "Gallina del valle, papas, huevos y su menjunje de cebolla china, rocoto, cancha y limón",
        calories: 400,
        price: 17.99,
      },
      {
